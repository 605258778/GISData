namespace ShapeEdit
{
    ...
    /// 删除重叠部分工具类
    /// </summary>
    [ProgId("ShapeEdit.OverlapDelete"), Guid("dd0572c4-b7e0-46f0-a979-d2220d21b5d1"), ClassInterface(ClassInterfaceType.None)]
    public sealed class OverlapDelete : BaseCommand, ITool
    {
        private List<IFeature> _features = new List<IFeature>();
        private IHookHelper m_hookHelper;
        private const string mClassName = "ShapeEdit.OverlapDelete";
        ...
        /// 删除重叠部分工具类:构造器
        /// </summary>
        public OverlapDelete()
        {
            base.m_category = "Topo";
            base.m_caption = "删除重叠部分";
            base.m_message = "将重叠部分删除";
            base.m_toolTip = "删除重叠部分";
            base.m_name = "Topo_OverlapDelete";
        }
